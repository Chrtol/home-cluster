...
from app.routers import auth, reptiles, feedings, foods, supplements, weight, health, stats, misting, schedules, schedule_instances, feeding_rotations, schedule_templates, supplement_rotation_templates, measurements, bulk, quotas, photos, streaks, responsibilities
from app.routers import households, invitations, notification_settings, notification_channels, notification_templates, template_groups, user_notifications
...
app.include_router(schedule_instances.router, prefix="/api", tags=["Schedule Instances"])
app.include_router(quotas.router, prefix="/api/quotas", tags=["Weekly Quotas"])
