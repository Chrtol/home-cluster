...
def upgrade():
    ...
    # Create enum for completion type
    completion_type = postgresql.ENUM(
        'feeding',
        'misting',
        'weighing',
        'manual',
    ...
    # Add time window fields to schedules table
    ...
    # Create schedule_completions table
    op.create_table(
    ...
    # Add schedule_completion_id to feedings table
    ...
    # Add schedule_completion_id to misting_logs table
    ...
    # Add schedule_completion_id to weight_logs table
