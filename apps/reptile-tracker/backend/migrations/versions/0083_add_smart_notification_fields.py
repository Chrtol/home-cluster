...
def upgrade():
    # Add smart notification fields to schedules table
    ...
    # Add frequency cap fields to notification_settings table
    op.add_column(
    ...
    # Create notification_frequency_tracking table
    op.create_table(
