  ...
  if (!stored) {
    ...
    const standardProfile = {
      ...
      dashboard_cards: [
        ...
        { id: 'week_summary', label: 'This Week', visible: true, order: 6, size: 'small', type: 'content' },
      ],
    ...
    const compactProfile = {
      ...
      dashboard_cards: [
        { id: 'today_summary', label: 'Today Summary', visible: true, order: 0, size: 'large', type: 'summary' },
        { id: 'compact_recent_activity', label: 'Recent Activity (Compact)', visible: true, order: 1, size: 'small', type: 'content', config: { itemCount: 3 } },
        { id: 'week_summary', label: 'This Week', visible: true, order: 2, size: 'small', type: 'content' },
        { id: 'weekly_calendar', label: 'Weekly Calendar', visible: true, order: 3, size: 'xs', type: 'content' },
        { id: 'weight_trends', label: 'Weight Trends', visible: true, order: 4, size: 'small', type: 'content', config: { timeRange: 90 } },
        { id: 'reptile_cards', label: 'Your Reptiles', visible: true, order: 5, size: 'xs', type: 'content' },
      ],
      statistics_charts: DEFAULT_STATISTICS_CHARTS,
      chart_settings: DEFAULT_CHART_SETTINGS,
      weight_interpolation_mode: 'linear',
    ...
    const mobileProfile = {
      ...
      dashboard_cards: [
        ...
        { id: 'week_summary', label: 'This Week', visible: true, order: 3, size: 'large', type: 'content' },
        { id: 'weekly_calendar', label: 'Weekly Calendar', visible: true, order: 4, size: 'xs', type: 'content' },
        { id: 'weight_trends', label: 'Weight Trends', visible: true, order: 5, size: 'large', type: 'content', config: { timeRange: 90 } },
      ],
      statistics_charts: DEFAULT_STATISTICS_CHARTS,
      chart_settings: DEFAULT_CHART_SETTINGS,
      weight_interpolation_mode: 'linear',
