    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="card">
          ...
          <p className="text-muted-foreground">This is your Reptile Tracker dashboard. More widgets and stats coming soon!</p>
        </div>
        <Link to="/reptiles" className="card hover:shadow-lg hover:border-primary-500/50 transition-all">
          ...
          <p className="text-muted-foreground">View, add, or edit your reptiles.</p>
        </Link>
        <Link to="/feed" className="card hover:shadow-lg hover:border-primary-500/50 transition-all">
          ...
          <p className="text-muted-foreground">Quickly log a new feeding for one of your reptiles.</p>
        </Link>
      </div>
    </div>
  );
