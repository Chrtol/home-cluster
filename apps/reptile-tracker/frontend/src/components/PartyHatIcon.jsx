 ...
 */
export default function PartyHatIcon({ className = '' }) {
  return (
    <svg
      viewBox="0 0 512 512"
      className={className}
      aria-hidden="true"
    >
      {/* Cone stripes - alternating fuchsia and cream/violet */}
      <g>
        {/* Orange stripe -> Fuchsia */}
        <path
          fill="#d946ef"
        ...
        />
        {/* Cream stripe -> Light violet/cream */}
        <path
          fill="#f5f3ff"
