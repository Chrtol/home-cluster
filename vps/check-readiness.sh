...
echo "  - vps-wireguard: VPS_IP, VPS_SSH_PORT (if not 22)"
echo "  - pangolin: PANGOLIN_VPS_SSH_PRIVATE_KEY, PANGOLIN_VPS_SSH_USER, PANGOLIN_DOMAIN, PANGOLIN_EMAIL"
echo "□ DNS records configured for your domain"
